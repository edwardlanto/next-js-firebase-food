...
export default async function DashboardDashBoardPage({ data }){
    let _categories = await categories;
    ...
    return (
        ...
        transition duration-500 ease-in-out overflow-y-auto"
                >
                    <div className="flex flex-col capitalize text-3xl"></div>
                    <div>
                        <div
                            className="mr-6 mt-8 py-2 flex-shrink-0 flex flex-col bg-white
