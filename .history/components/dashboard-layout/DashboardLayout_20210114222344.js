								...
								bg-gray-100 dark:bg-gray-200 rounded-lg"
									...
									text-gray-600 my-3"
                                        >
                                            ...
                                            Explicabo assumenda porro sapiente,
                                            cum nobis tempore delectus
                                            consectetur ullam reprehenderit quis
                                            ducimus, iusto dolor nam corporis id
                                            perspiciatis consequuntur saepe
                                            excepturi.
                                        </p>
		...
		dark:text-gray-400 rounded-r-lg overflow-y-auto"
			...
			bg-green-400 shadow focus:outline-none"
                >
                    ...
                    <svg
                        class="h-5 w-5 fill-current mr-2 ml-3"
                        viewBox="0 0 24 24"
                    >
